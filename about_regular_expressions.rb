...
# If the part of the regular expression before * fails to match then * will also fail to match
  end
  ...
  #
  # Why?
  # Because they take the first matching string that comes their way?
  # ------------------------------------------------------------------
  ...
  def test_character_classes_give_options_for_a_character
    ...
    assert_equal ["cat","bat","rat"], animals.select { |b| b[/[cbr]at/] }
  end
  ...
  # Character classes are designed to match only one out of several options while alternation
  # Character classes are designed to match only one out of several options while alternation
  # allows for different ranges of options
